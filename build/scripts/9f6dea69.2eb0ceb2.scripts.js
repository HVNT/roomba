!function (window, undefined) {
  ...
  jQuery.event = {
    ...
    jQuery.event.special[orig] = {
      ...
      handle: function (event) {
        ...
        return handleObj.selector, (!related || related !== target && !jQuery.contains(target, related)) && (event.type = handleObj.origType, ret = handleObj.handler.apply(this, arguments), event.type = fix), ret;
      }
    };
  ...
  a.widget = function (b, c, d) {
    ...
    a.fn[c] = function (e) {
      ...
      return e = !f && g.length ? a.extend.apply(null, [
        !0,
        e
      ].concat(g)) : e, f && '_' === e.charAt(0) ? h : (f ? this.each(function () {
  ...
  a.widget('ui.resizable', a.ui.mouse, {
    ...
    _mouseDrag: function (b) {
      ...
      return a.browser.msie && a.browser.version < 7, this.sizeDiff, this._updateVirtualBoundaries(b.shiftKey), (this._aspectRatio || b.shiftKey) && (l = this._updateRatio(l, b)), l = this._respectSize(l, b), this._propagate('resize', b), c.css({
    ...
    resize: function (b) {
      ...
      e._aspectRatio || b.shiftKey, e.grid = 'number' == typeof e.grid ? [
        e.grid,
        e.grid
      ] : e.grid;
  ...
  a.widget('ui.sortable', a.ui.mouse, {
    ...
    _mouseCapture: function (b, c) {
      ...
      if (a(b.target).parents().each(function () {
        ...
        }), a.data(b.target, d.widgetName + '-item') == f && (e = a(b.target)), !e)
        return !1;
    ...
    animations: {
      slide: function (b, c) {
        if (b = a.extend({
          ...
          return b.toShow.animate({
            height: 'show',
            paddingTop: 'show',
            paddingBottom: 'show'
          }, b), void 0;
        if (!b.toShow.size())
          return b.toHide.animate({
            height: 'hide',
            paddingTop: 'hide',
            paddingBottom: 'hide'
          }, b), void 0;
  ...
  a.widget('ui.menu', {
    ...
    move: function (a, b, c) {
      if (!this.active)
        return this.activate(c, this.element.children(b)), void 0;
    ...
    nextPage: function (b) {
      if (this.hasScroll()) {
        if (!this.active || this.last())
          return this.activate(b, this.element.children('.ui-menu-item:first')), void 0;
    ...
    previousPage: function (b) {
      if (this.hasScroll()) {
        if (!this.active || this.first())
          return this.activate(b, this.element.children('.ui-menu-item:last')), void 0;
        var c = this.active.offset().top, d = this.element.height(), e = this.element.children('.ui-menu-item').filter(function () {
            var b = a(this).offset().top - c + d - a(this).height();
            return 10 > b && b > -10;
          });
  ...
  a.widget('ui.slider', a.ui.mouse, {
    ...
    _refreshValue: function () {
      ...
      this.options.values && this.options.values.length ? this.handles.each(function (b) {
        f = 100 * ((d.values(b) - d._valueMin()) / (d._valueMax() - d._valueMin())), g['horizontal' === d.orientation ? 'left' : 'bottom'] = f + '%', a(this).stop(1, 1)[e ? 'animate' : 'css'](g, c.animate), d.options.range === !0 && ('horizontal' === d.orientation ? (0 === b && d.range.stop(1, 1)[e ? 'animate' : 'css']({ left: f + '%' }, c.animate), 1 === b && d.range[e ? 'animate' : 'css']({ width: f - h + '%' }, {
          queue: !1,
          duration: c.animate
  ...
  a.widget('ui.tabs', {
    ...
    load: function (b) {
      ...
      if (this.abort(), !f || 0 !== this.element.queue('tabs').length && a.data(e, 'cache.tabs'))
        return this.element.dequeue('tabs'), void 0;
        ...
        html5Mode ? (basePath = $browser.baseHref() || '/', pathPrefix = pathPrefixFromBase(basePath), appBaseUrl = composeProtocolHostPort(initUrlParts.protocol, initUrlParts.host, initUrlParts.port) + pathPrefix + '/', $location = $sniffer.history ? new LocationUrl(convertToHtml5Url(initUrl, basePath, hashPrefix), pathPrefix, appBaseUrl) : new LocationHashbangInHtml5Url(convertToHashbangUrl(initUrl, basePath, hashPrefix), hashPrefix, appBaseUrl, basePath.substr(pathPrefix.length + 1))) : (appBaseUrl = composeProtocolHostPort(initUrlParts.protocol, initUrlParts.host, initUrlParts.port) + (initUrlParts.path || '') + (initUrlParts.search ? '?' + initUrlParts.search : '') + '#' + hashPrefix + '/', $location = new LocationHashbangUrl(initUrl, hashPrefix, appBaseUrl)), $rootElement.bind('click', function (event) {
          ...
          if ($location.absUrl() != newUrl) {
            if ($rootScope.$broadcast('$locationChangeStart', newUrl, $location.absUrl()).defaultPrevented)
              return $browser.url($location.absUrl()), void 0;
  ...
  function formatNumber(number, pattern, groupSep, decimalSep, fractionSize) {
    ...
    if (hasExponent)
      ...
      if (whole.length >= lgroup + group) {
        ...
        for (var i = 0; pos > i; i++)
          0 === (pos - i) % group && 0 !== i && (formatedText += groupSep), formatedText += whole.charAt(i);
      }
      for (i = pos; i < whole.length; i++)
        0 === (whole.length - i) % lgroup && 0 !== i && (formatedText += groupSep), formatedText += whole.charAt(i);
  ...
  forEach('input,select,option,textarea,button,form'.split(','), function (value) {
    ...
    text: extend(9 > msie ? function (element, value) {
      ...
      return isUndefined(value) ? element.textContent : (element.textContent = value, void 0);
    }, { $dv: '' }),
        ...
        link: function (scope, elm, attr, ctrl) {
          if (ctrl) {
            ...
            var validator = function (value) {
              return attr.required && (isEmpty(value) || value === !1) ? (ctrl.$setValidity('required', !1), void 0) : (ctrl.$setValidity('required', !0), value);
            };
    ...
    return uiConfig.currency && angular.extend(options, uiConfig.currency), {
      ...
      link: function (scope, element, attrs, controller) {
        ...
        opts = angular.extend({}, options, scope.$eval(attrs.uiCurrency)), renderview = function (viewvalue) {
          var num;
          return num = 1 * viewvalue, element.toggleClass(opts.pos, num > 0), element.toggleClass(opts.neg, 0 > num), element.toggleClass(opts.zero, 0 === num), '' === viewvalue ? element.text('') : element.text(currencyFilter(num, opts.symbol)), !0;
    ...
    link: function (scope, elm, attrs, ctrl) {
      ...
      validateExpr && (angular.isString(validateExpr) && (validateExpr = { validator: validateExpr }), angular.forEach(validateExpr, function (expression, key) {
        validateFn = function (valueToValidate) {
          return scope.$eval(expression, { $value: valueToValidate }) ? (ctrl.$setValidity(key, !0), valueToValidate) : (ctrl.$setValidity(key, !1), void 0);
  ...
  function ($scope, $timeout, $transition) {
    ...
    self.currentSlide = null, self.select = function (nextSlide, direction) {
      ...
      slides.splice(index, 1), slides.length > 0 && slide.active && (index >= slides.length ? self.select(slides[index - 1]) : self.select(slides[index]));
    };
  }
...
dialogModule.controller('MessageBoxController', [
    ...
    return {
      ...
      link: function (scope, element, attr) {
        ...
        attr.$observe('popover', function (val) {
          ...
          scope.tt_isOpen ? scope.$apply(hide) : scope.$apply(show);
        });
      }
    };
  }
    ...
    return {
      ...
      link: function (originalScope, element, attrs, modelCtrl) {
        ...
        resetMatches(), scope.query = void 0, modelCtrl.$parsers.push(function (inputValue) {
          return resetMatches(), selected ? inputValue : (inputValue && inputValue.length >= minSearch && getMatchesAsync(inputValue), void 0);
  ...
  function s(t, o, n, s) {
    var a = [
        ...
        n,
        s
      ].join('-'), f = 0.01 + 100 * (n / s), l = Math.max(1 - (1 - t) / o * (100 - f), t), u = i.substring(0, i.indexOf('Animation')).toLowerCase(), d = u && '-' + u + '-' || '';
  ...
  function c(t) {
    return 'undefined' == typeof this ? new c(t) : (this.opts = l(t || {}, c.defaults, p), void 0);
  }
  function h() {
    function t(t, e) {
...
angular.module('segmentio', ['ng']).factory('segmentio', [
  ...
  return {
    ...
    link: function (scope, element, attrs, ctrl) {
      scope.$watch(function () {
        ...
        return viewValue === origin ? (ctrl.$setValidity('passwordMatch', !0), viewValue) : (ctrl.$setValidity('passwordMatch', !1), void 0);
      });
    }
  };
  ...
  function addAnimation(alpha, trail, i, lines) {
    var name = [
        ...
        i,
        lines
      ].join('-'), start = 0.01 + 100 * (i / lines), z = Math.max(1 - (1 - alpha) / trail * (100 - start), alpha), prefix = useCssAnimations.substring(0, useCssAnimations.indexOf('Animation')).toLowerCase(), pre = prefix && '-' + prefix + '-' || '';
  ...
  function ($_api, $q, $http, States, $rootScope, segmentio) {
    function ItemFactory(collection) {
      ...
      return Item.collection = collection, Item.dimensions = collection.dimensions, Item.path = collection.path, Item.query = function (tag) {
        ...
        }), self.progressClass = ''), this.completion = parseInt(100 * (fieldCounter.filled / fieldCounter.total), 10), this.completion + '%';
        ...
        return this.raw ? this.raw.page ? 2 == this.raw.page.status : !1 : !1;
      }, Item;
    }
    return ItemFactory;
  }
      ...
      resolve: {
        init: function ($q, $http, User, Users) {
          ...
          return User.get().then(function (user) {
            User.isAdmin ? defer.resolve(Users.init()) : defer.resolve(user);
          }), defer.promise;
        },
  ...
  function ($scope, Market, $routeParams, $location, $q, $dialog, Users, User) {
    ...
    $scope.items = Market.visibleItems, $scope.dimensions = Market.dimensions, $scope.activeItem = Market.getActive(), $scope.activeItemResources = {}, $scope.collectionID = $routeParams.collection, $scope.collection = Model.collection, $scope.srcListingDetails = '/app/market/partials/' + $scope.collection.key + '-details.html?v=' + Date.now(), $scope.searchBy = { $: '' }, $scope.marketView = { collapseFilters: !0 }, $scope.activeSearch = {
      ...
      saveAll().then(function () {
        saveStats.geoFails || saveStats.saveFails ? $scope.setGlobalAlert([
          {
            type: 'success',
  ...
  function ($scope) {
    ...
    $scope.notPublished = function (item) {
      ...
      $scope.clearGlobalAlerts(), _.isEmpty($scope.activeItemResources) ? item.$geocode().then(function (response) {
        return response.status ? $scope.addGlobalAlert({
          type: 'success',
      ...
      link: function (scope, element) {
        function setupSlider() {
          $(element).slider({
            ...
            max: 100,
            values: [
              parseInt(100 * ((scope.range.lowSelected - scope.range.low) / (scope.range.high - scope.range.low)), 10),
              parseInt(100 * ((scope.range.highSelected - scope.range.low) / (scope.range.high - scope.range.low)), 10)
            ],
            step: 1,
