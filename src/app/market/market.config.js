    ...
    .config(function ($stateProvider, $tooltipProvider, $urlRouterProvider) {
        ...
        $stateProvider
            ...
            .state('market.mdu', {
                ...
                resolve: {
                    load: function ($q, MDU, MDUMarket, News, NewsMarket, $log, StatesPolygon, User, Comment, Hidden, Favorite, CustomField, RentMetrics, MarketState) {
                        ...
                        RentMetrics.ping().then(function (response) {
                            if (response.status === 200) {
                                MarketState.isRentMetricsEnabled = true;
                            } else {
                                MarketState.isRentMetricsEnabled = false;
                            }
                        }, function () {
                            MarketState.isRentMetricsEnabled = false;
                        });
