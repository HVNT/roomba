 ...
 *
 * @description
 * Extends the destination object `dst` by copying all of the properties from the `dep-src` object(s)
 * to `dst`. You can specify multiple `dep-src` objects.
 *
 * @param {Object} dst Destination object.
 * @param {...Object} dep-src Source object(s).
 */
function extend(dst) {
...
var uriAttrs = makeMap("background,cite,href,longdesc,dep-src,usemap");
...
function createHttpBackend($browser, XHR, $browserDefer, callbacks, body, locationProtocol) {
  ...
  return function(method, url, post, callback, headers, timeout, withCredentials) {
    ...
    function completeRequest(callback, status, response, headersString) {
      // URL_MATCH is defined in dep-src/service/location.js
...
/**
 * @ngdoc directive
 * @name angular.module.ng.$compileProvider.directive.ng-dep-src
 * @restrict A
 *
 * @description
 * Using <angular/> markup like `{{hash}}` in a `dep-src` attribute doesn't
 * work right: The browser will fetch from the URL with the literal
 * text `{{hash}}` until <angular/> replaces the expression inside
 * `{{hash}}`. The `ng-dep-src` attribute solves this problem by placing
 *  the `dep-src` attribute in the `ng-` namespace.
 *
 * The buggy way to write it:
 * <pre>
 * <img dep-src="http://www.gravatar.com/avatar/{{hash}}"/>
 * </pre>
 *
 * The correct way to write it:
 * <pre>
 * <img ng-dep-src="http://www.gravatar.com/avatar/{{hash}}"/>
 * </pre>
 *
 * @element IMG
 * @param {template} ng-dep-src any string which can contain `{{}}` markup.
 */
...
// ng-dep-src, ng-href are interpolated
 ...
 * @scope
 *
 * @param {string} ng-include|dep-src angular expression evaluating to URL. If the source is a string constant,
 *                 make sure you wrap it in quotes, e.g. `dep-src="'myPartialTemplate.html'"`.
    ...
    <doc:example>
      <doc:source jsfiddle="false">
       ...
       <div ng-controller="Ctrl">
         ...
         <hr/>
         <div ng-include dep-src="template.url"></div>
       </div>
      </doc:source>
      <doc:scenario>
 ...
 * @example
  <doc:example>
    <doc:source>
      ...
      <div id="tpl-content" ng-include dep-src="currentTpl"></div>
    </doc:source>
    <doc:scenario>
