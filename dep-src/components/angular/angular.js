    ...
    return {
      ...
      link: function(scope, element, attr) {
        attr.$observe(normalized, function(value) {
          ...
          // on IE, if "ng:dep-src" directive declaration is used and "dep-src" attribute doesn't exist
          // then calling element.setAttribute('dep-src', 'foo') doesn't do anything, so we need
 ...
 * @scope
 *
 * @param {string} ngInclude|dep-src angular expression evaluating to URL. If the source is a string constant,
